/////// SOLUTIONS OF THE ASSIGNMENT QUESTIONS--19 ///////
...
function sortArray(nums) {
  ...
  console.log(sortedArray); /// Output: [1, 2, 3, 5]
...
function moveZeroesToEnd(arr) {
  ...
  console.log(result1); ///Output: [1, 9, 8, 4, 2, 7, 6, 0, 0, 0, 0]
...
function alternatePosNeg(arr) {
  ...
  console.log(resultTwo); // Output: [-5, 5, -2, 2, -8, 4, 7, 1, 8, 0]
...
function mergeSortedArrays(arr1, arr2) {
  ...
  console.log(mergedArray2); //Output: [4, 5, 7, 8, 8, 9]
...
function intersection(nums1, nums2) {
  ...
  console.log(intersects); //Output: [2]
...
function intersection(nums1, nums2) {
  ...
  console.log(intersect); //Output: [2, 2]
